...
ms.locfileid: "43715806"
---
# <a name="your-group-aimkiobject-not-showing-in-groups-list"></a>Din gruppe "{AimKIObject}" vises ikke på listen Grupper

Distributionsgruppen med navnet "{AimKIObject}" blev oprettet {AimKITimeElapsed} minutter siden. Det kan tage op til 60 minutter, før din nye gruppe vises i Administration.
