...
Azure Active Directory (Azure AD) Seamless Single Sign-On (Seamless SSO) logger automatisk brugere på, når de er på virksomhedens stationære computere, der har forbindelse til virksomhedens netværk.
