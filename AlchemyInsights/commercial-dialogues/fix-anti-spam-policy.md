...
ms.locfileid: "58313457"
---
# <a name="fix-anti-spam-policy"></a>Ret antispampolitik

En af dine antispampolitikker har påvirket denne meddelelse. Hvis du vil gennemse politikken, skal du gøre følgende:
...
3. I pop op-menuen med  oplysninger skal du klikke på Rediger grænseværdi for spam og egenskaber i sektionen & egenskaber for **spammail,** vælge Rediger handlinger og gennemse indstillingerne for Markér som **spam.**
