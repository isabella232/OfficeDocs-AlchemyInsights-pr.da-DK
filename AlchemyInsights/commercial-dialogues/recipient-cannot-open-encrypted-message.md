...
---
# <a name="fix-problem-of-viewing-protected-message-in-outlook"></a>Løs problem med visning af beskyttet meddelelse i Outlook
...
1. Afhængigt af den mailklient, der bruges, skal **du klikke på Læs** meddelelsen eller en lignende prompt. Brugerne omdirigeres til en side, hvor de kan logge på og modtage en engangskode.

> [!NOTE]
> Gmail-brugere bliver bedt om at logge på med Gmail. Meddelelsen åbnes under en ny fane, når du klikker **på** Tillad.
