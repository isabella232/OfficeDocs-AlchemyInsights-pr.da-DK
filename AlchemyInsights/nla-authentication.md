...
ms.locfileid: "51420744"
---
# <a name="nla-authentication"></a>NLA-godkendelse

Hvis du vil have hjælp til fejlfinding i forbindelse med godkendelsesfejl eller NLA-fejl, der opstår, når du bruger en RDP-forbindelse (Remote Desktop Protocol) til at oprette forbindelse til en virtuel Azure-maskine (VM), skal du se:
