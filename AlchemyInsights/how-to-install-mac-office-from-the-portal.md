...
3. [Tildel licenser til brugere](https://docs.microsoft.com/microsoft-365/admin/subscriptions-and-billing/assign-licenses-to-users).

4. Brugerne kan derefter installere Office-softwaren selv, eller du kan bruge [Installer Office til dine Mac-brugere](https://docs.microsoft.com/DeployOffice/mac/deployment-guide-for-office-for-mac).