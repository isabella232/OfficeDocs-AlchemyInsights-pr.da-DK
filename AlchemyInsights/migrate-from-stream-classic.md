...
Du kan finde flere oplysninger om overførsel fra klassisk stream til ny stream i [Overfør fra Microsoft Stream (klassisk) til den nye Microsoft Stream](https://docs.microsoft.com/stream/classic-migration)