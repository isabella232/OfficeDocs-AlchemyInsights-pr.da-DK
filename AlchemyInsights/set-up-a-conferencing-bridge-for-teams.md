...
ms.locfileid: "42953754"
---
# <a name="set-up-a-conferencing-bridge-for-teams"></a>Konfigurer en konferencebro til Teams

Du skal kun konfigurere lydmøder for personer, der skal planlægge eller lede møder. Vi har lavet en trinvis proces til at fuldføre konfigurationen af telefonsystemet. Gennemse [Konfiguration af telefonsystem i din organisation](https://docs.microsoft.com/MicrosoftTeams/phone-number-calling-plans/port-order-overview).
