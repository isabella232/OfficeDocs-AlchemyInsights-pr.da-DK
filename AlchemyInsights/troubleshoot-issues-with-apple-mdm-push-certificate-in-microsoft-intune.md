...
---
# <a name="troubleshoot-issues-with-apple-mdm-push-certificate-in-microsoft-intune"></a>Fejlfinding af problemer med Apple MDM-pushcertifikat i Microsoft Intune

Gennemse ressourcerne nedenfor for at løse problemet nu.
  
1. Gennemse [dette dokument for](https://docs.microsoft.com/intune/apple-mdm-push-certificate-get) at konfigurere eller forny Apple MDM-pushcertifikat.
