...
---
# <a name="fixing-the-office-apps-weve-run-into-a-problem-with-your-subscription-message"></a>Løse Office-appsene "Vi er løbet ind i et problem med dit abonnement"

Hvis du modtager denne meddelelse, kan du prøve følgende:

- Hvis du for nylig har skiftet til et andet Microsoft 365-abonnement/-abonnement, skal du følge trinnene i ["Kontomeddelelse" vises i Office, når du har skiftet Microsoft 365-abonnementer](https://support.office.com/article/account-notice-appears-in-office-after-switching-office-365-plans-857dc33a-1efc-4ce7-ac3f-ef616314e27d) for at geninstallere eller opdatere Office.
- Se [Office-fejl "Kontomeddelelse: Vi er løbet ind i et problem med dit Microsoft 365-abonnement".](https://support.office.com/article/office-error-account-notice-we-ve-run-into-a-problem-with-your-office-365-subscription-17f71ecb-f53c-4f3d-ae18-7230ca1594c1) 
- [Fjern](https://docs.microsoft.com/microsoft-365/admin/manage/remove-licenses-from-users) og [tildel en licens](https://docs.microsoft.com/microsoft-365/admin/manage/assign-licenses-to-users) til den berørte bruger igen.
