...
Før du importerer kontakter til Outlook.com, skal du eksportere dem fra din anden mailudbyder som en .csv-fil. Følg derefter vejledningen nedenfor.
...
.
2. Vælg **Administrer** \> **importkontakter**øverst på siden .
3. Vælg **Gennemse**, naviger til den mappe, hvor du gemte dine eksporterede kontakter, og vælg **Åbn**.
